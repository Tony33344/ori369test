    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="text-gray-700 mb-6 leading-relaxed flex-grow">{service.shortDescription}</p>
              <Link
        ...
        <div className="text-center mt-12">
          <Link
            href="/terapije"
            className="inline-block px-8 py-4 bg-[#00B5AD] text-white font-semibold rounded-lg hover:bg-[#009891] transition-colors shadow-lg"
          >
            Vse terapije →
          </Link>
        </div>
